...
@section('content')
	...
	<h3 class="text-2xl mb-4">Users</h3>
	...
	<div class="flex justify-between gap-6">
		...
		<div class="w-full">
			<div class="overflow-hidden p-2 px-5 bg-sky-400 rounded-t-lg text-white text-2xl w-full">
				List user
			</div>
			<div id="card" class="overflow-hidden p-4 bg-white rounded-b-lg border shadow-lg sm:p-6 dark:bg-gray-800 dark:border-gray-700 w-full h-[320px]">
				<div class="relative overflow-x-auto sm:rounded-md mb-5">
					<table class="w-full table-auto overflow-y-auto text-sm text-left text-gray-500 dark:text-gray-400">
						<thead class="text-xs text-gray-700 uppercase bg-teal-200 dark:bg-gray-700 dark:text-gray-400 sticky top-0">
							<tr>
						...
						<tbody>
							@foreach ($users as $user)
								<tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
									...
									<td	td class="px-6 py-2">{{ $user->username }}</td>
									<td class="px-6 py-2">{{ $user->is_admin == true ? 'Admin' : "Kasir" }}</td>
